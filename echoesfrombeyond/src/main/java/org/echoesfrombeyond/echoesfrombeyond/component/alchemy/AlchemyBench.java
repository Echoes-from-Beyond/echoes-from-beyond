...
package org.echoesfrombeyond.echoesfrombeyond.component.alchemy;
...
public class AlchemyBench implements Component<ChunkStore> {
  ...
  public static void registerComponentType(ComponentRegistryProxy<ChunkStore> proxy) {
    COMPONENT_TYPE = proxy.registerComponent(AlchemyBench.class, "AlchemyBench", CODEC);
  }

  /**
   * @return the component type
   */
  public static ComponentType<ChunkStore, AlchemyBench> getComponentType() {
    assert COMPONENT_TYPE != null;
    return COMPONENT_TYPE;
  }

  // not unused, this is called reflectively
