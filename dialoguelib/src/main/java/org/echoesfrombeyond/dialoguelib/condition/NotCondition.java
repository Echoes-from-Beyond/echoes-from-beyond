...
@Doc(
    """
    ChoiceCondition that inverts another condition.
    """)
@NullMarked
@ModelBuilder
public class NotCondition implements ChoiceCondition {
  ...
  @Doc(
      """
      The condition to invert. If not specified, this will never
      display.
      """)
  public @Nullable ChoiceCondition Delegate;
  ...
  public boolean shouldDisplay(Ref<EntityStore> activator, Dialogue parent, DialogueChoice choice) {
    ...
    return !delegate.shouldDisplay(activator, parent, choice);
  }
}
