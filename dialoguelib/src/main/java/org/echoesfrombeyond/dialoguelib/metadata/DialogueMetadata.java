...
/**
 * Interface defining components that deal with setting simple forms of data (booleans, integers,
 * text) through dialogue choices. These are referred to as "metadata" in configuration and
