...
package org.echoesfrombeyond.plantingyourroots.condition;
...
@ModelBuilder
@NullMarked
public class TalkedToCondition implements ChoiceCondition {
  public static final BuilderCodec<TalkedToCondition> CODEC =
      CodecUtil.modelBuilder(
          TalkedToCondition.class, DialoguePlugin.getResolver(), Plugin.getSharedCache());
