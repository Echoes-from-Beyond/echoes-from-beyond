...
@NullMarked
public class InitializeKweebdrasilSystem extends RefSystem<EntityStore> {
  @Override
  ...
  public void onEntityAdded(
    ...
    var roots = buffer.ensureAndGetComponent(player, RootsComponent.getComponentType());
    plugin.initializeKweebdrasil(world, roots);
  }
