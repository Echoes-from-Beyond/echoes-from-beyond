...
@NullMarked
@ModelBuilder
public class AppendDiaryEntry implements ChoiceAction {
  public static final BuilderCodec<AppendDiaryEntry> CODEC =
      CodecUtil.modelBuilder(
          AppendDiaryEntry.class, Plugin.getSharedResolver(), Plugin.getSharedCache());

  public @Nullable DiaryEntry Entry;
